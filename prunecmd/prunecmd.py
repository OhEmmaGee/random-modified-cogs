...
class Prunecmd(commands.Cog):
    ...
    async def prunecmd(self, ctx, confirm: bool):
        ...
        """Prunes the discord member list of your guild. Cunts with 14 days of inactivity are getting fucked too :)"""
        if ctx.assume_yes or confirm:
            await ctx.guild.prune_members(days=14, compute_prune_count=False, reason="Bitches with 14 days of inactivity / No role were pruned.")
